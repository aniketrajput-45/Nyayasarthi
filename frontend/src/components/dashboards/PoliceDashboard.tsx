...
export const PoliceDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/analytics/police`, {
  ...
  const cards = [
   ...
   return (
    <div className="p-8">
      <h2 className="text-3xl font-bold text-slate-900 mb-8">Police Dashboard</h2>
