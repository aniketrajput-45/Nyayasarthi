...
const caseTypes = ['civil', 'criminal', 'commercial', 'family', 'property', 'other'];
...
export const FileCase: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/cases/file`, {
        method: 'POST',
        headers: {
    ...
    return (
      <div className="p-8">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Case Filed Successfully</h2>
          <p className="text-slate-600 mb-6">Your case has been registered. You will be redirected to your cases.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-bold text-slate-900 mb-8">File a New Case</h2>
